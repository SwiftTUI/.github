...
**Build Swift Terminal User Interfaces with Views, State, Observation,
Gestures, and Animations: SwiftUI semantics, drawn in terminal cells.**

![Swift 6.3](https://img.shields.io/badge/Swift-6.3-F05138?logo=swift&logoColor=white)
![Platforms](https://img.shields.io/badge/platforms-macOS%20·%20Linux%20·%20iOS%20·%20WASI%20·%20Android-1E90FF)
![Status](https://img.shields.io/badge/pre--release-0.8.11-DAA520)
...
`App` (same view tree, same `@State`, same `@FocusState`) also
...
- **State in, screen out.** Views are a pure function of your app's state:
  ...
  cells that changed. You never write a draw loop, diff buffers, or track
  repaints.
...
- **One compiled binary.** Swift 6 compiles your interface into a single fast
  ...
  build time, and tests render frames as integer-cell rasters without a
  TTY.
